...
public:
     ...
     */
    TemplatedExecutable1(T value, const std::string& itemName = "Executable1") 
        : data(value), name(itemName) {}
...
using IntExecutable1 = TemplatedExecutable1<int>;
using StringExecutable1 = TemplatedExecutable1<std::string>;
using DoubleExecutable1 = TemplatedExecutable1<double>;
